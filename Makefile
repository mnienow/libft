...
SRC = ft_arrlen.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
ft_isdigit.c ft_isnumber.c ft_isprint.c ft_itoa.c ft_lstadd.c ft_lstdel.c \
...
ft_putnbr.c ft_putstr_fd.c ft_putstr.c ft_strcat.c ft_strchr.c ft_strclr.c \
